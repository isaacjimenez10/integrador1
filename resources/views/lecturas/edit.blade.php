...
<body>
    <div class="container">
        ...
        <form action="{{ url('lecturas/'.$lectura->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <select id="sensor_id" name="sensor_id">
                @foreach($sensores as $sensor)
                    <option value="{{ $sensor->id }}" {{ $lectura->sensor_id == $sensor->id ? 'selected' : '' }}>
                        {{ $sensor->nombre }}
                    </option>
                @endforeach
            </select><br>
            ...
            <input type="number" id="valor" name="valor" value="{{ $lectura->valor }}" required><br>
            
            <label for="unidad">Unidad:</label>
            <input type="text" id="unidad" name="unidad" value="{{ $lectura->unidad }}" required><br>

            <label for="fecha_hora">Fecha y Hora:</label>
            <input type="datetime-local" id="fecha_hora" name="fecha_hora" value="{{ $lectura->fecha_hora }}" required><br>
